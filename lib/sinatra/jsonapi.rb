  ...
  module JSONAPI
    module Helpers
      ...
      def serialize_response_body
        case response.content_type && response.content_type[/^[^;]+/]
        when /json$/, /javascript$/
        ...
        halt 400, 'Malformed entities in the response body'
      end
    ...
    def self.registered(app)
      ...
      app.before do
        ...
        halt 415 unless request.content_type[/^[^;]+/] == mime_type(:api_json)
      end
    end
